package com.projetocompleto.ProjetoCompleto.api.exceptionhandler;

import com.projetocompleto.ProjetoCompleto.domain.exception.EntidadeNaoEncontradaException;
import com.projetocompleto.ProjetoCompleto.domain.exception.NegocioException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        List<Problem.Campo> campos = new ArrayList<Problem.Campo>();
